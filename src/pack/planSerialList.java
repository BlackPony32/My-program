...
public class planSerialList extends myFrame
{
    planSerialList()
    {
        super("Список запланованих серіалів");
        ...
        JTable table = new JTable(new ModelSerialLater());
        ...
        table.setRowHeight(30);
        {
            ...
            btn_action_11_to_10 back = new btn_action_11_to_10();
        ...
        //зміна довжини ячейок таблиці
        {
            ...
            hdr3.setPreferredWidth(380);

            table.setShowGrid(true);//присутні рамки таблиці
            table.setGridColor(Color.YELLOW);//рамка жовта
        }
        CSVFile Rd = new CSVFile();
        ModelSerialLater NewModel = new ModelSerialLater();
        table.setModel(NewModel);
        File DataFile = new File("PlanToWatchSerial.csv");
