...
public class planListF extends myFrame
{
    planListF()
    {
        super("Список запланованих фільмів");
        ...
        JTable table = new JTable(new ModelFilmLater());
        ...
        table.setRowHeight(30);
        {
            ...
            btn_action_8_to_9 back = new btn_action_8_to_9();
        ...
        //зміна довжини ячейок таблиці
        {
            ...
            hdr2.setPreferredWidth(372);

            table.setShowGrid(true);//присутні рамки таблиці
            table.setGridColor(Color.YELLOW);//рамка жовта
        }
        CSVFile Rd = new CSVFile();
        ModelFilmLater NewModel = new ModelFilmLater();
        table.setModel(NewModel);
        File DataFile = new File("PlanToWatch.csv");
