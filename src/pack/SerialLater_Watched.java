...
public class SerialLater_Watched extends myFrame
{
    SerialLater_Watched()
    {
        super("Списки серіалів");
        ...
        ImageIcon ii = new ImageIcon("src/img/choose.gif");
        ...
        panel.add(imageLabel);
        {
            ...
            btn_action_10_to_1 to_first_pg = new btn_action_10_to_1();
            btn1.addActionListener(to_first_pg);
            container.add(btn1);
        }
        //кнопка додати контакт
        {
            CircleBtn btn2 = new CircleBtn("Список серіалів ''на потім''");
            btn2.setFont(new Font("Arial", Font.PLAIN, 18));
            btn2.setBorderPainted(false);
            btn2.setFocusPainted(false);
            btn2.setBackground(Color.GRAY);
            btn2.setBounds(520,45,270,50);
            btn_action_10_to_11 to_third_pg = new btn_action_10_to_11();
            btn2.addActionListener(to_third_pg);
            container.add(btn2);
        }
        {
            CircleBtn btn3 = new CircleBtn("Список переглянутих серіалів");
            btn3.setFont(new Font("Arial", Font.PLAIN, 18));
            btn3.setBorderPainted(false);
            btn3.setFocusPainted(false);
            btn3.setBackground(Color.GRAY);
            btn3.setBounds(55,45,295,50);
            btn_action_10_to_12 watched_s = new btn_action_10_to_12();
            btn3.addActionListener(watched_s);
            container.add(btn3);
        }
