...
public class WatchedSerialList extends myFrame
{
    WatchedSerialList()
    {
        super("Список переглянутих серіалів");
        ...
        ImageIcon img = new ImageIcon("img/listLaterfilms.png");
        ...
        JTable table = new JTable(new ModelSerialWatched());
        ...
        table.setBackground(Color.PINK);//фон таблиці
        ...
        table.setRowHeight(30);
        {
            ...
            btn_action_12_to_10 back = new btn_action_12_to_10();
        ...
        //зміна довжини ячейок таблиці
        {
            ...
            TableColumn hdr6 = table.getTableHeader().getColumnModel().getColumn(6);
            TableColumn hdr7 = table.getTableHeader().getColumnModel().getColumn(7);
            ...
            hdr1.setPreferredWidth(165);
            hdr2.setPreferredWidth(165);
            hdr3.setPreferredWidth(165);
            hdr4.setPreferredWidth(165);
            hdr5.setPreferredWidth(165);
            hdr6.setPreferredWidth(165);
            hdr7.setPreferredWidth(380);

            table.setShowGrid(true);//присутні рамки таблиці
            table.setGridColor(Color.YELLOW);//рамка жовта
        }
        CSVFile Rd = new CSVFile();
        ModelSerialWatched NewModel = new ModelSerialWatched();
        table.setModel(NewModel);
        File DataFile = new File("WatchedSerial.csv");
        ...
        label.setBounds(130,420,270,40);
        JTextField textField = new JTextField(15);
        textField.setBounds(400,430,250,25);
